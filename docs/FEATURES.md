...
> **Status:** v0.8 (2026-09-25). The answers to Q1–Q16 are applied (see [§8 Decision log](#8-decision-log)), and the P0 spikes passed on the main target machine. The tech stack is in [TECH-STACK.md](TECH-STACK.md); drum detection and beat tracking are described in [ANALYSIS.md](ANALYSIS.md).
